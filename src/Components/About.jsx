    ...
    <div className="" onClick={close} id="main">
      <div className="overlay-content" onClick={(e) => e.stopPropagation()}>
        <div className="flex justify-end">
          <button className="close text-2xl p-2 rounded-full" onClick={close}>
            <IoClose />
          </button>
        </div>
        ...
        <div className="flex flex-col">
          <div className="flex flex-row pb-2">
            <p className="">
              Hello! I’m a MERN Stack Developer dedicated to crafting efficient,
              user-centered web applications with a keen eye for both design and
              functionality. I am skilled in designing intuitive user
              interfaces, managing backend operations, and implementing secure
              authentication systems. I’m passionate about staying updated with
              the latest industry trends and technologies to deliver modern,
